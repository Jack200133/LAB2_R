---
title: "Analisis y Arima Pricing"
...
Tenemos que el precio del Combustible Superior va desde 21.91 a 43.24 en su punto mas alto representando un 75% estab debajo de 35.57. El Conmbustible Regula esta Arriba de 21.11 y la media esta alrededor de 31.21. El Diesel esta dentro de 17.61 hasta un maximo de 41.27
...
Podemos observar en el histograma deel Disel que su distribucion no es normal y tiende a variar bastante
...
Al igual que el diesel, la gasolina super no tiene una distribucion normal pero tiende a dos numeros que son alrededor de 28 y 34
...
# Por ejemplo, para la serie de Gasolina Superio
...
# Predecir 10 meses adelante (asumiendo una frecuencia diaria)
...
checkresiduals(modelo_arima_110)
...
```{r}
modelos <- list(modelo_auto_arima, modelo_arima_110)
comparacion <- sapply(modelos, function(x) c(AIC = AIC(x), BIC = BIC(x)))
